...
import { ChevronLeft, ChevronRight, Eye, X, ArrowRight, Mail } from "lucide-react"
...
export default function Home() {
  ...
  // Fix for error at line 128: useState call missing initial value or function call missing argument
  // No such issue found in the code, so likely a function call missing argument
  // I will check the calls to scrollToSection or other functions to ensure arguments are passed correctly
  ...
  // Removed duplicate declaration of openProductDetails to fix redeclaration error
            ...
            entries.forEach((entry) => {
              ...
              if (entry.isIntersecting && entry.intersectionRatio >= 0.3) {
                if (sectionId in sections) {
                  setActiveSection(sectionId as keyof typeof sections)
                }
              }
            })
          },
  ...
  // Removed duplicate declaration of closeProductDetails to fix redeclaration error
  ...
  // Removed duplicate declarations of pauseAutoPlay and resumeAutoPlay to fix redeclaration errors
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-[Poppins,sans-serif]">
            ...
            <div className="container mx-auto px-4 space-y-2">
              <button
                ...
                className={`block w-full text-left py-2 px-4 ${
                  activeSection === "home" ? "bg-red-500 text-white" : "text-gray-800"
              ...
              <button
                onClick={() => scrollToSection("about")}
                className={`block w-full text-left py-2 px-4 ${
                  activeSection === "about" ? "bg-red-500 text-white" : "text-gray-800"
                } rounded hover:bg-red-600 hover:text-white transition-colors font-medium`}
              >
                ABOUT US
              </button>
              <button
                onClick={() => scrollToSection("products")}
                className={`block w-full text-left py-2 px-4 ${
                  activeSection === "products" ? "bg-red-500 text-white" : "text-gray-800"
                } rounded hover:bg-red-600 hover:text-white transition-colors font-medium`}
              >
                PRODUCTS
              </button>
              <button
                onClick={() => scrollToSection("foodSafety")}
                className={`block w-full text-left py-2 px-4 ${
                  activeSection === "foodSafety" ? "bg-red-500 text-white" : "text-gray-800"
                } rounded hover:bg-red-600 hover:text-white transition-colors font-medium`}
              >
                FOOD SAFETY & CERTIFICATIONS
              </button>
              <button
                onClick={() => scrollToSection("contact")}
                className={`block w-full text-left py-2 px-4 ${
                  activeSection === "contact" ? "bg-red-500 text-white" : "text-gray-800"
                } rounded hover:bg-red-600 hover:text-white transition-colors font-medium`}
              >
                CONTACT US
              </button>
      ...
      <main>
        ...
        <div ref={sectionRefs.about} id="about" className="py-12 bg-gray-100">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-center max-w-4xl mx-auto mb-6">
              ...
              premium-quality raw maize, coconut, and green millet to international markets.
            </p>
            <p className="text-center max-w-4xl mx-auto mb-6 text-gray-700 leading-relaxed">
              ...
              Practices (GAP). As trusted raw maize exporters, coconut exporters, and green millet suppliers from India,
              we have built long-term partnerships with certified farmers to ensure sustainable sourcing and consistent
              quality.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed text-justify text-sm md:text-base">
                  ...
                  freshness, rich water content, and long shelf life. Sourced directly from trusted farms, our coconuts
                  meet international standards and are carefully graded for global delivery.
                </p>
                <button
              ...
              <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed text-justify text-sm md:text-base">
                  ...
                  fertile regions of India. Our maize is rich in nutrients, free from toxins, and ideal for enhancing
              ...
              <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed text-justify text-sm md:text-base">
                  ...
                  digestibility, making it an excellent choice for cattle feed and poultry nutrition. Sourced from the
                  finest farms in India.
                </p>
                <button
        ...
        {/* Food Safety Section */}
        <div ref={sectionRefs.foodSafety} id="foodSafety" className="py-12 bg-white">
          <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4 text-sm md:text-base">
                PRIMOX TRADING CO is a leading exporter of premium quality raw maize, coconut, and green millet from
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button onClick={() => scrollToSection("products")} className="text-gray-400 hover:text-white">
                    Products
                  </button>
                </li>
                <li>
